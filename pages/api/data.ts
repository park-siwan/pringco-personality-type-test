...
export const mockupData: Data[] = [
  {
    ...
    firstAnswer: { desc: `'당구공 마을? 너무 기대된다 설레>< 뭐 입고가지?'`, type: 'P' },
  ...
  },
  {
    ...
    firstAnswer: { desc: `'이 마을은 원래 이렇게 입장하나 보다.' 하며 앞구르기를 한다`, type: 'S' },
    secondAnswer: { desc: `'왜 앞구르기를 하면서 들어가는 거지?' 하는 의문을 가진다.`, type: 'N' },
  },
  {
    question: `3. 숙소 키를 받아 방에 들어가 보니, 내 방에만 웰컴 쿠키가 없는 거 같다. 이때 나는?`,
    firstAnswer: { desc: `'왜 나만 없지..?' 누군가 알아차려 줄 때까지 기다린다.`, type: 'I' },
  ...
  },
  {
    ...
    firstAnswer: { desc: `몇 시에 무슨 행사가 잡혀 있는지 처음부터 차분히 읽어본다.`, type: 'S' },
    secondAnswer: { desc: `전체적으로 한번 훑어보고 관심 있는 거 몇 개만 기억해둔다.`, type: 'N' },
  },
  {
    question: `6. 마을 축제에 다양한 행사가 준비되어 있다. 참여하고 싶은 곳은?`,
    firstAnswer: { desc: `혼자 여유롭게 들을 수 있는 동물 합창단의 음악 감상회`, type: 'I' },
  ...
  },
  {
    ...
    secondAnswer: { desc: `그래도 메인보컬은 오리가 하는 게 좋을 거 같은데?`, type: 'T' },
  },
  {
  ...
  },
  {
    ...
    firstAnswer: { desc: `피곤해 죽을 거 같은데.. 자고 내일 치워야겠다~`, type: 'P' },
    secondAnswer: { desc: `피곤하지만 치우고 편하게 자야지~`, type: 'J' },
  },
  {
    question: `11. 집으로 돌아가기 전날, 동물 친구들에게 줄 머핀을 굽기로 했다.`,
    firstAnswer: { desc: `한 이만큼 구우면 인당 하나씩 줄 수 있겠지?`, type: 'N' },
    secondAnswer: { desc: `인당 하나씩 주려면.. 10개만 구우면 되겠다!`, type: 'S' },
  },
  {
