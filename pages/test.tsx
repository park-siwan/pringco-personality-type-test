...
import { personalityType, mockupData } from './api/data';
...
import type { characterList } from '../src/type';
...
export default function Test() {
  ...
  const handleFirstAnswer = (type: personalityType) => {
  ...
  function Answer() {
    return (
      <div className={'flex flex-col w-full items-center'}>
        <button
          onClick={() =>
            handleFirstAnswer(mockupData[typeCounts.step].firstAnswer.type)
          }
        ...
        <button
          onClick={() =>
            handleFirstAnswer(mockupData[typeCounts.step].secondAnswer.type)
          }
